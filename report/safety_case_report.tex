...
\end{subfigure}
\caption{Grad-CAM overlays for the pedestrian detector. Panel (a) is inside the ODD;
(b)--(d) are outside it. Warm colours indicate high attribution, so a uniform blue tint
means the map is essentially flat.}
